...
%% plotting
make_panel_5B();
make_panel_5C("tissue_300by900_localization_feedback");
...
make_panel_5D_5E(fnamelist,fnamelist_grad);

make_panel_5G();
make_panel_5H("tissue_retention_1_retention_feedback");
...
make_panel_5I_5J(fnamelist,fnamelist_grad);
